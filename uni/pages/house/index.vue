<template>
  <view class="house-container">
    ...
    <view class="content" v-if="currentTab === 'history'">
      <view class="chart-section">
        <view class="chart-header">
          <text class="chart-title"><image class="inline-icon" src="/static/emojis/emoji_28_droplet.png" /> 用水量 (m³)</text>
      ...
      <view class="chart-section">
        <view class="chart-header">
          <text class="chart-title"><image class="inline-icon" src="/static/emojis/emoji_53_lightning.png" /> 用电量 (kWh)</text>
          <text class="chart-period">近7天</text>
        </view>
        <view class="chart-box">
          <view class="chart-bars">
      ...
      <view class="chart-section">
        <view class="chart-header">
          <text class="chart-title"><image class="inline-icon" src="/static/emojis/emoji_27_fire.png" /> 用气量 (m³)</text>
          <text class="chart-period">近7天</text>
        </view>
        <view class="chart-box">
          <view class="chart-bars">
    ...
    <view class="content" v-if="currentTab === 'forecast'">
      <view class="chart-section">
        <view class="chart-header">
          <text class="chart-title"><image class="inline-icon" src="/static/emojis/emoji_28_droplet.png" /> 用水量预测 (m³)</text>
      ...
      <view class="chart-section">
        <view class="chart-header">
          <text class="chart-title"><image class="inline-icon" src="/static/emojis/emoji_53_lightning.png" /> 用电量预测 (kWh)</text>
          <text class="chart-period">未来7天</text>
        </view>
        <view class="chart-box">
          <view class="chart-bars forecast">
      ...
      <view class="chart-section">
        <view class="chart-header">
          <text class="chart-title"><image class="inline-icon" src="/static/emojis/emoji_27_fire.png" /> 用气量预测 (m³)</text>
          <text class="chart-period">未来7天</text>
        </view>
        <view class="chart-box">
          <view class="chart-bars forecast">
