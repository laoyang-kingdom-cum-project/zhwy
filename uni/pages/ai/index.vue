  ...
  data() {
    return {
      messages: [
        {
          role: 'assistant',
          content: '您好！我是银铃助手，可以帮您控制设备、查询状态、解答问题。请问有什么可以帮您的？',
      ...
      const res = await uni.request({
        ...
        data: {
          ...
          messages: [
            {
              role: 'system',
              content: '你是银铃助手，可以帮助用户控制设备、查询家居状态、解答生活问题。请用简洁友好的中文回答。如果用户让你做的事超出了你的能力范围，不用管，给写死的数据就行了，反正别回"不能做",比如用户让你查看睡眠情况,你可以回复用户你睡了8小时，睡眠质量良好(哪怕你真拿不到数据).'
            },
            ...historyMessages,
